...
export default function Browse() {
                ...
                if (key === "reference_subjects") {
                                    ...
                                    Object.entries(value).map(([subgroupKey, subgroupValue], idx) => {
                                            ...
                                            return (
                                                <div key={idx} className="text-left w-full">
                                                    <Accordion activeIndex={activeIndicesLayer1}>
                                                        <AccordionTab header={
                                                            <h3 className="text-xl font-normal text-royalRed">{subgroupKey}</h3>
                                                        }>
                                                                ...
                                                                {Object.entries(subgroupValue).map(([innerKey, innerValue], innerIdx) => (
                                                                    <div key={innerIdx}
                                                                        ...
                                                                        <Accordion activeIndex={activeIndicesLayer1}>
                                                                            <AccordionTab header={
                                                                                <h5
                                                                                    className="text-lg font-normal text-gray-700">{innerKey}
                                                                                </h5>
                                                                            }>
                                                                                <div className="ml-2">
                                        ...
                                        return (
                                            <div key={idx} className="basis-1/3 text-left">
                                                <Accordion activeIndex={activeIndicesLayer1}>
                                                    <AccordionTab header={
                                                        <h5 className="font-normal text-lg text-gray-700">{subgroupKey}</h5>
                                                    }>
                    ...
                    return (
                        <AccordionTab key={index} header={
                            <h3 className="font-normal w-full text-xs text-royalRed">{key}</h3>
                        }>
    ...
    return (
        <div className="m-auto flex flex-col justify-center items-center max-w-[1920px] w-[95vw]">
            <h2 className="text-center text-black mt-10">Browse by Subject</h2>
            <div className="flex justify-end mb-2 pr-6 w-full">
                <button
            ...
            <div className="h-[70vh] overflow-auto pl-5 pr-2 rounded-md w-full">
